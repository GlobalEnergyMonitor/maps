...
def process_steel_iron_parent(df, test_results_folder):
    ...
    plant_df_grouped = plant_df.groupby('Plant ID').agg({
        ...
        'Construction Nominal iron capacity (ttpa)': 'sum',
        'Construction Nominal DRI capacity (ttpa)': 'sum',
        'Operating pre-retirement Nominal crude steel capacity (ttpa)': 'sum',
        'Operating pre-retirement Nominal BOF steel capacity (ttpa)': 'sum',
        'Operating pre-retirement Nominal iron capacity (ttpa)': 'sum',
        'Operating pre-retirement Nominal BF capacity (ttpa)': 'sum',
        'Operating pre-retirement scaling-cap': 'sum',
        ...
        'Cancelled Nominal crude steel capacity (ttpa)': 'sum',
        'Cancelled Nominal EAF steel capacity (ttpa)': 'sum',
        'Cancelled scaling-cap': 'sum',
        'Retired Nominal iron capacity (ttpa)': 'sum',
        'Retired Nominal BF capacity (ttpa)': 'sum',
        'Announced Other/unspecified iron capacity (ttpa)': 'sum',
        'Mothballed Nominal BOF steel capacity (ttpa)': 'sum',
        'Cancelled Nominal iron capacity (ttpa)': 'sum',
        'Cancelled Nominal DRI capacity (ttpa)': 'sum',
        'Retired Nominal crude steel capacity (ttpa)': 'sum',
        'Retired Nominal BOF steel capacity (ttpa)': 'sum',
        'Retired scaling-cap': 'sum',
        ...
        'Cancelled Other/unspecified iron capacity (ttpa)': 'sum',
        'Retired Nominal OHF steel capacity (ttpa)': 'sum',
        'Operating Other/unspecified iron capacity (ttpa)': 'sum',
        'Mothballed Other/unspecified iron capacity (ttpa)': 'sum',
        ...
        'Construction Other/unspecified iron capacity (ttpa)': 'sum',
        'Mothballed Other/unspecified steel capacity (ttpa)': 'sum',
        'Operating pre-retirement Other/unspecified steel capacity (ttpa)': 'sum',
        'Mothballed pre-retirement Nominal iron capacity (ttpa)': 'sum',
        'Mothballed pre-retirement Nominal BF capacity (ttpa)': 'sum',
        'Operating pre-retirement Other/unspecified iron capacity (ttpa)': 'sum',
