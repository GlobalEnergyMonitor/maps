var config = {
    ...
    json: 'LNG Terminals-map-file-2024-10-08.geojson', //this is where you put the map output file
    color: {
        field: 'status-legend',
        values: {
            'operating': 'red',
    ...
    filters: [
        {
            ...
            values_labels: ['OPERATING test','Proposed/Announced/Discovered', 'Construction/In development','Retired/Closed/Decommissioned','Cancelled','Mothballed/Idle/Shut in','Shelved']
