var config = {
    ...
    tableHeaders: {
        values: ['project-name', 'project-name-in-local-language-/-script', 'phase-name', 'capacity-(mw)', 'installation-type', 'status', 'start-year', 'owner', 'operator',  'state/province', 'country/area'],
